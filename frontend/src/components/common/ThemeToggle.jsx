...
title={currentLabel}
className={`relative inline-flex items-center justify-center p-2 rounded-xl text-xs font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-400 focus:ring-offset-2 ${
        isDark
...
>
{isDark ? ( <Sun className="w-4 h-4 transition-transform duration-200 hover:rotate-45" />
